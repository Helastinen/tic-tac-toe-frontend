...
import { Nullable, PlayerMark, SquareProps, WinningLine } from "../../types/types.js";

const Square = ({
  onSquareClick, index, value, winningLine, disabled, invalidMove, isLatestMove
}: SquareProps) => {
  const getSquareBehavior = () => {
    ...
    if (isLatestMove) { classes.push("square-latest-move"); }
